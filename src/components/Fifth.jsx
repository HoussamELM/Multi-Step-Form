...
const Fifth = () => {
    return (
        <div className={styles.container}>
            ...
            <p>Thanks for confirming your subscription! We hope you have fun using our platform. if you ever need support, please feel free to email us at support@whatever.com.</p>
        </div>
    )
}
